import { filterType, filterGeneration, orderByNumber, orderByNumberDes, orderNameAscending, orderNameDescending } from '../src/data.js';
...
describe('deberia ordenar número ascendente', () => {
  it("orden numero ascendente", () => {
    ...
    expect(orderByNumber(listaPokemon, numAscendente)).toEqual([{
